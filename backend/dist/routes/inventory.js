 ...
 */
router.get("/warehouse", auth_1.authenticateToken, auth_1.requireAnyRole, async (req, res) => {
    try {
...
router.get("/schools/:schoolId", auth_1.authenticateToken, auth_1.requireAnyRole, async (req, res) => {
    try {
